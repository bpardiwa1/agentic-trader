...
# rotate logs online (no restart needed), keep files manageable
nssm set AgenticTraderAPI AppRotateFiles   1
nssm set AgenticTraderAPI AppRotateOnline  1
nssm set AgenticTraderAPI AppRotateBytes   10485760   # 10 MB
nssm set AgenticTraderAPI AppRotateSeconds 86400      # 1 day
